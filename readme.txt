...
Plugin Name: MerchantOne Payment Gateway WooCommerce Addon
Plugin URI: https://wordpress.org/plugins/webmicro-merchantone-woo-addon/
Tags: woocommerce, merchantone,merchantone for woocommerce,credit card payment with Merchant One,merchantone payment gateway for woocommerce,merchantone for woocommerce,merchantone payment gateway for woocommerce,merchantone woocommerce plugin,merchantone aim plugin wordpress,merchantone woocommerce plugin,merchantone payment gateway plugin,merchantone payment gateway plugin for wordpress
